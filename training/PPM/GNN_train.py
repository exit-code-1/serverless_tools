...
def main():
    """
    Main function for PPM-GNN training.
    This function is called by train.py to train PPM-GNN models.
    """
    import sys
    ...
    # If called from train.py, these will be set via sys.argv
    ...
    # PPM models are stored in: models/{train_mode}/PPM/GNN/
    ppm_model_dir = os.path.join(output_paths['model_dir'], 'PPM', 'GNN')
    ...
    output_file = os.path.join(output_paths['prediction_dir'], f'ppm_gnn_predictions_{train_mode}.csv')
    ...
    # Train models
    print("Starting PPM-GNN model training...")
    train_gnn_models(
        query_features_train_csv=train_paths['plan_info'],
    ...
    # Evaluate models
    print("Starting PPM-GNN model evaluation...")
    evaluate_gnn_models(
    ...
    print(f"PPM-GNN training completed. Models saved to: {ppm_model_dir}")
