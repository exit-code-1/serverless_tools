...
def process_and_train_curve(train_data, test_data, operator, test_size=0.2, epochs=100, lr=0.001):
    """
    ...
    X_train, X_test, y_train, y_test = utils.prepare_data(
        ...
        test_data = test_data,
        operator=operator,
        feature_columns=['l_input_rows', 'r_input_rows', 'estimate_costs', 'actual_rows', 'instance_mem', 'estimate_costs','estimate_rows',
